(*
 Example: Work Google Voice account keepalive
...
-- Example: a second profile is often "Profile 1"
property profileDirectory : "Profile 1"

-- Example Google Voice conversation URL (FAKE EXAMPLE)
-- Users should replace this with their own conversation URL
property conversationURL : "https://voice.google.com/u/0/messages?itemId=t.EXAMPLE_WORK_THREAD"

-- Tag so you know which account sent it
property accountTag : "[WORK GV] "
